...
#define _LABEL2(arg) cont_label##arg
#define _LABEL1(arg) _LABEL2(arg)
#define _LABEL _LABEL1(__LINE__)
...
#define YIELD() do {_thread_support_cur_place = &&_LABEL; return; _LABEL:;} while(0)
